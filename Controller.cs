...
public class Controller : MonoBehaviour
{
	...
	{
		if (vesselToRecover.vesselAchievements.Contains("Passed the Karman Line, leaving the /atmosphere and reaching space."))
		{
			MyAchievements.main.UnlockAchievement("CgkIpOK5-NMPEAIQCw");
		}
	}
